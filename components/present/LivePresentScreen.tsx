...
/**
 * The unmodified Phase 1/2 live presentation: schedule-driven current
 * block, transitions, Prep, and student-facing lesson lookup, all off the
 * real wall clock. Phase 2.5's Preview Mode (`PreviewPresentScreen`) is a
 * separate component precisely so this one never has to change to support
 * it - the schedule engine and its rules stay exactly as they were.
 */
